...
const Navbar = () => {
  ...
  return (
    ...
    <div className='navbar'>
     ...
     <li onClick={()=>{setMenu('men')}}><Link style={{textDecoration:'none'}} to="/mens">Men</Link>{menu==="men"?<hr/>:<div></div>}</li>
     <li onClick={()=>{setMenu('women')}}><Link style={{textDecoration:'none'}} to="/womens">Women</Link>{menu==="women"?<hr/>:<div></div>}</li>
